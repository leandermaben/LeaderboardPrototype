            ...
            <section className="main-container">
                <div className="content-wrapper" style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                    <div style={{background: 'black', padding: '1.5em 1em', color: 'white', borderRadius: '1em', textAlign: 'center', width: '80%'}}>
                        ...
                        <a href="https://github.com/swe-bench/experiments/" className="light-blue-link" target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-github"></i> SWE-bench/experiments
                        </a>
                    </div>
                </div>
                ...
                <div className="content-wrapper">
                    <div className="content-box" id="reasoning-traces">
